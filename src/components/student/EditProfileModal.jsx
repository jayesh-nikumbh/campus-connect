...
import { X, Camera, User, Building2, BookOpen, Mail, Phone } from 'lucide-react'
...
export default function EditProfileModal({ isOpen, onClose, user, onProfileUpdated }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Dialog */}
      <div
        className="relative z-10 w-full max-w-xl rounded-3xl transition-colors duration-300 shadow-2xl overflow-hidden p-6 sm:p-7"
        style={{
